...
| `[~]`  | Visual Design and Interaction Polish | `docs/phases/visual-design-interaction-polish.md`             | `docs/qa/visual-design-interaction-polish-qa.md` | Slices 1-4 are implemented and verified. Shared component source now reaches into Slices 5-7; active work is the ComponentPlayground acceptance/evidence checkpoint before Home. |
...
| `[~]`  | 5. Card And Linked Surface Foundation                   | Shared `Card` linked-surface source and playground examples exist. Validate geometry, accessibility, and Card/PocCard consolidation before broad use. |
| `[~]`  | 6. Supporting Shared Visual Components                  | Chips, stat cards, progress, segmented controls, feedback, and state components exist. Motion/accessibility hardening and acceptance evidence remain. |
| `[~]`  | 7. ComponentPlayground Acceptance Gate                  | Active checkpoint: verify the component-check route as the shared primitive review gate, record evidence, and update docs before production screens.  |
